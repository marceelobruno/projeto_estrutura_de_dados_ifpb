...
try:
    ...
    while True:
        ...
        while True:
            try:
                menuInicial = int(input('Digite 1 para iniciar um jogo manualmente\nDigite 2 para carregar um arquivo de texto\n'))
        ...
        if menuInicial == 2:
            while True:
                try:
                    # jogador = jogo.carregaJogo()
                    jogador = [jogo.carregaJogo() for jogador ]
